...
void MediumGrainedTestInsertUndDelete(){
    List<int> list;
    vector<thread>  threads;
    int thNum = 4;
    int elNum = 1000;
...
void Test() {
    ...
    RUN_TEST(tr, Erase);
    RUN_TEST(tr, Equal);
    RUN_TEST(tr, MediumGrainedTestInsert);
    RUN_TEST(tr, MediumGrainedTestDelete);
    RUN_TEST(tr, MediumGrainedTestInsertUndDelete);
}
